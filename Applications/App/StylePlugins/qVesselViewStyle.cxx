...
// --------------------------------------------------------------------------
qVesselViewStyle::qVesselViewStyle()
{
}
...
//------------------------------------------------------------------------------
QPalette qVesselViewStyle::standardPalette()const
{
  ...
  palette.setColor(QPalette::Link, "#7A9BC4");
  palette.setColor(QPalette::LinkVisited, "#FFFFFF");
